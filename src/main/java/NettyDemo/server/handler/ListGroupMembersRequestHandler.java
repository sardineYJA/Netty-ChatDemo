...
import NettyDemo.protocol.request.ListGroupMembersRequestPacket;
import NettyDemo.protocol.response.ListGroupMembersResponsePacket;
...
public class ListGroupMembersRequestHandler extends SimpleChannelInboundHandler<ListGroupMembersRequestPacket> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, ListGroupMembersRequestPacket requestPacket) {
        ...
        if (channelGroup == null)  // 群聊 groupId 不存在
            return;
